...
2. การดำเนินการทางคณิตศาสตร์: สามารถทำ Union (รวม), Intersection (หาจุดร่วม), และ Difference (หาความแตกต่าง) ระหว่าง Set ได้อย่างรวดเร็ว (Time Complexity _O(N)_ เมื่อ _N_ คือจำนวนสมาชิกที่เล็กที่สุด)
